...
| ticks | array | [] | Used to define the values of the ticks. Overwrites min and max options. |
| snap | float | 0 | Used to define the bounds of a tick. Snaps to the tick if value is within these bounds. |
